...
namespace System.Runtime.Analyzers
{
    ...
    {
        private static readonly ImmutableArray<SyntaxKind> nodeKindsOfInterest =
        ...
        protected override Analyzer GetAnalyzer(CompilationStartAnalysisContext context, CompilationMSInternalTypes types)
        {
            Analyzer analyzer = new CSharpAnalyzer(types);
            context.RegisterSyntaxNodeAction(analyzer.AnalyzeNode, nodeKindsOfInterest);
            return analyzer;
        }

        private sealed class CSharpAnalyzer : Analyzer
        {
            public CSharpAnalyzer(CompilationMSInternalTypes compilationTypes)
            ...
            {
                Debug.Assert(nodeKindsOfInterest.Contains(methodNode.Kind()));
